document.addEventListener("DOMContentLoaded", () => {
  ...
  const words = [
    ...
    { japanese: "ラーメン", romaji: "ra-men" },
    { japanese: "カレー", romaji: "kare-" },
    { japanese: "ピザ", romaji: "piza" },
    { japanese: "チョコレート", romaji: "chokore-to" },
    ...
    { japanese: "ジュース", romaji: "ju-su" },
    { japanese: "アイスクリーム", romaji: "aisukuri-mu" },
    { japanese: "コーヒー", romaji: "ko-hi-" },
    { japanese: "ビール", romaji: "bi-ru" },
